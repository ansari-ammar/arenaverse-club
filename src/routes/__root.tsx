...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ArenaVerse — Luxury Gaming & Cinema Club | United University" },
      { name: "description", content: "Premium gaming arena, mini theatre, food lounge & tournaments inside United University, Prayagraj. Play. Chill. Compete." },
      { name: "author", content: "ArenaVerse" },
      { property: "og:title", content: "ArenaVerse — Luxury Gaming & Cinema Club" },
      { property: "og:description", content: "Experience entertainment beyond campus. Gaming, movies, tournaments, food & more." },
